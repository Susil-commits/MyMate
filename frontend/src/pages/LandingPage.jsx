        ...
        <div className="md:hidden bg-white/95 backdrop-blur-xl border-b border-gray-100 animate-slide-down">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-3 border-t border-gray-100 flex gap-3">
              <Link to="/user/login" onClick={() => setMobileOpen(false)} aria-label="Sign In as User (Mobile)" className="flex-1 text-center text-sm font-medium text-gray-700 py-2.5 rounded-xl border border-gray-200">Sign In</Link>
              <Link to="/user/register" onClick={() => setMobileOpen(false)} aria-label="Register as User (Mobile)" className="flex-1 text-center text-sm font-semibold text-white py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600">Get Started</Link>
            </div>
          </div>
        </div>
      )}
    ...
    <section className="relative min-h-screen flex items-center bg-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed animate-fade-up animate-delay-200">
          ...
          <div className="mt-14 grid grid-cols-3 gap-8 max-w-md animate-fade-up animate-delay-400">
            <div><div className="text-2xl font-extrabold text-gray-900">{driverCount.toLocaleString()}</div><div className="text-sm text-gray-600">Drivers</div></div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce-gentle">
        <HiChevronDown className="w-6 h-6 text-gray-300" />
      </div>
    </section>
  );
}
    ...
    <section id="features" ref={ref} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="mt-4 text-lg text-gray-600">From discovering trusted drivers to seamless booking and secure payments — we have got you covered.</p>
        </div>
    ...
    <section id="how-it-works" ref={ref} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="mt-4 text-lg text-gray-600">Four simple steps to get on the road with a trusted driver.</p>
        </div>
    ...
    <section id="testimonials" ref={ref} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center max-w-2xl mx-auto mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="mt-4 text-lg text-gray-600">Reviews from verified customers and drivers on our platform.</p>
        </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-all duration-700 ${visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
            ...
            <p className="mt-6 text-lg text-gray-300 leading-relaxed">MyMate was born from a simple idea: finding a reliable driver shouldn't be a gamble. We built a platform where drivers are verified, reviews are genuine, and locality-based matching connects you with the right person — every time.</p>
            ...
            <div className="relative">
              <div className="w-full aspect-square max-w-sm mx-auto bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-3xl border border-gray-700/50 backdrop-blur-sm flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-gray-300 text-lg">Drive with confidence.</p>
                  <div className="mt-6 flex items-center justify-center gap-4">
                    ...
                    <span className="text-sm text-gray-300">Trusted by many</span>
                  </div>
                </div>
              </div>
        ...
        <div className={`transition-all duration-700 ${visible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl border border-gray-100 shadow-2xl p-12 sm:p-16">
              ...
              <p className="mt-4 text-lg text-gray-600 max-w-xl mx-auto">Join MyMate and connect with trusted drivers in your locality today.</p>
        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4 mt-6">
              <span className="flex items-center gap-2 text-sm text-gray-600"><FaPhoneAlt className="w-3.5 h-3.5" /> +1 (555) 123-4567</span>
              <span className="flex items-center gap-2 text-sm text-gray-600"><FaEnvelope className="w-3.5 h-3.5" /> hello@mymate.app</span>
            </div>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-4">For Users</h3>
            <div className="space-y-3 text-sm">
              <p><Link to="/user/register" aria-label="Footer Create User Account" className="hover:text-white transition-colors">Create Account</Link></p>
              <p><Link to="/user/login" aria-label="Footer User Sign In" className="hover:text-white transition-colors">Sign In</Link></p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <p><Link to="/driver/register" aria-label="Footer Register as Driver" className="hover:text-white transition-colors">Register</Link></p>
              <p><Link to="/driver/login" aria-label="Footer Driver Sign In" className="hover:text-white transition-colors">Sign In</Link></p>
