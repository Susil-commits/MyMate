...
export default function NotificationBell() {
 ...
 className="relative p-2 rounded-xl hover:text-gray-700 transition-colors"
 ...
 className={`flex items-start gap-3 p-4 hover:text-gray-700 transition-colors border-b border-gray-50 last:border-0 ${
